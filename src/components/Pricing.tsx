...
export function Pricing() {
    ...
    return (
        <section id="pricing" ref={containerRef} className="py-24 md:py-32 bg-slate-50 dark:bg-zinc-950 overflow-hidden relative">
            {/* Background Accents */}
            <div className="absolute top-1/4 -left-24 w-96 h-96 bg-blue-500/5 rounded-full blur-[100px] pointer-events-none" />
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                {/* Grid + Robot together in a relative wrapper */}
                <div className="relative pt-40 md:pt-48">
                    {/* Robot positioned above the grid touching the cards */}
                    <div ref={pricingRobotRef} className="absolute -top-41 inset-x-0 mx-auto z-20 pointer-events-none w-72 h-72 md:w-96 md:h-96 drop-shadow-[0_20px_60px_rgba(59,130,246,0.25)] opacity-0">
                        <Image
                            src="/M2.png"
                    ...
                    <div className="pricing-grid grid grid-cols-1 md:grid-cols-3 gap-8 items-end">
                        {plans.map((plan, idx) => (
                            <div
                                key={idx}
